...
// MarginBorrowRepayService margin borrow and repay
...
// OpType operation type BORROW or REPAY
func (s *MarginBorrowRepayService) OpType(opType MarginOpType) *MarginBorrowRepayService {
	s.opType = opType
	return s
}
